...
//Used for nameing D3D12 Objects that inherit from: ID3D12Object.
#define D3D12_NAME_OBJECT(c,s) (SetDebugN(c,s))
//Used for nameing D3D12 Objects that inherit from: ID3D12Pageable.
